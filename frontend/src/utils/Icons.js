...
export const news=<i class="fas fa-newspaper"></i>
export const link=<i class="fa fa-link" aria-hidden="true"></i>
export const down=<i class="fa-sharp fa-solid fa-arrow-down"></i>
export const advise=<i class="fa-solid fa-handshake"></i>
export const user=<i class="fa-solid fa-user"></i>
export const lock=<i class="fa-solid fa-lock"></i>
export const chvright=<i class="fa-solid fa-chevron-right"></i>
export const emailic=<i class="fa-solid fa-envelope"></i>
export const res=<i class="fa-solid fa-book-open"></i>
export const reslink=<i class="fa-solid fa-arrow-up-right-from-square"></i>